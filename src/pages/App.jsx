...
function App() {
  ...
  return (
    <><header>
    <img className="logo" src="./Billeder/toplogo.gif" alt="" />
    <h1 className="headingOne">Velkommen</h1>
...
disse grupper, og det er disse børn, vi gerne vil gøre noget for.
    ...
    <strong>Foreningen Børnelejren på Langeland samler penge ind fra erhvervslivet, fonde og private
